...
def main():
	try:
		...
		#Personal Dashboard
			...
			if python_ex == 'exercise 0':
				ex.hello_world()
				pass
			elif python_ex == 'exercise 1':
				ex.input_exercise()
				pass
			elif python_ex == 'exercise 2':
				ex.button_exercise()
				pass
			elif python_ex == 'exercise 3':
				ex.using_if_else()
				pass
			elif python_ex == 'challenge 1':
				ex.button_input_exercise()
				pass
			elif python_ex == 'exercise 4':
				ex.using_session_state()
				pass
			elif python_ex == 'exercise 5':
				ex.rule_based_question_answering()
				pass
			elif python_ex == 'challenge 2':
				ex.rule_based_question_answering_challenge()
				pass
			elif python_ex == 'exercise 6':
				ex.simple_data_structure()
				pass
			elif python_ex == 'exercise 7':
				ex.display_dictionary_in_dataframe()
				pass
			elif python_ex == 'exercise 8':
				ex.loop_exercise()
				pass
			elif python_ex == 'exercise 9':
				ex.streamlit_form_exercise()
				pass
			elif python_ex == 'challenge 3':
			...
			pass
		elif st.session_state.option == '2. Open AI API Call':
			...
			pass
		elif st.session_state.option == '3. Chatbot':
			# call the API call exercise function here
			ex.ai_chatbot()
			pass
		elif st.session_state.option == '4. Chatbot with Streaming':
			# call the openai basebot with streaming function here
			ex.basebot()
			pass
		elif st.session_state.option == '5a. Prompt Design Template':
			# call the prompt design function here
			ex.prompt_design()
			pass
		elif st.session_state.option == '5. Chatbot with Prompt Design Template':
			# call the openai basebot with prompt design function here
			ex.prompt_design()
			ex.basebot_prompt_design()
			pass
		elif st.session_state.option == '6a. Memory':
		...
		elif st.session_state.option == 'GenAI Chatbot':
